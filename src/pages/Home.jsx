...
const login = (state) => engine_rest.auth.login(state, "demo", "demo");
const cookies = (state) => engine_rest.auth.cookies(state);
...
export const Home = () => {
  ...
  return (
    <main class="p-3">
      <button onClick={() => cookies(state)}>Cookies</button>
      <button onClick={() => login(state)}>Login</button>

      <h2>Welcome to Operaton!</h2>
      <p>
        You can find general information on operaton on{" "}
        <a href="https://operaton.org">operaton.org</a>.
      </p>
      ...
      <p>
        ...
        like to contribute to the project, check out our public git repository:
      </p>
      <ul>
        <li>
      ...
      <p>
        If you encountered an error while using Operaton, please create a ticket
        to let us know:
      </p>
      <ul>
        <li>
      ...
      <p>
        ...
        this as well. Please keep in mind, that features which a very specific
        to an organization might be better added as an extension, not as part of
        the official community code.
      </p>
      <ul>
        <li>
          <a href="https://forum.operaton.org">
            Discuss feature ideas on the forum
          </a>
        </li>
        <li>
          <a href="https://github.com/operaton/operaton/issues">
